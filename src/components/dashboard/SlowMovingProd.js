			...
			<div className="d-flex justify-content-between justify-items-center arrow-container  mb-4">
				<div className="text-right">
					<h2
						...
						className="text-large mb-3 mr-3 text-dark-1">
					...
					<h2
						...
						className="text-medium mb-3 mr-3 text-dark-1">
					...
					<h2
						...
						className="text-slim mb-3 mr-3 text-dark-1">
				...
				<div className="text-left">
					<h2 className="text-large mb-3 ml-3 text-dark-1">
						{allSlowProducts[0] !== "undefined"
							? `${allSlowProducts[0]?.orderCount || ""}`
							: ""}
					</h2>
					<h2 className="text-medium mb-3 ml-3 text-dark-1">
						{allSlowProducts[1] !== "undefined"
							? `${allSlowProducts[1]?.orderCount || ""}`
							: ""}
					</h2>
					<h2 className="text-slim mb-3 ml-3 text-dark-1">
						{allSlowProducts[2] !== "undefined"
